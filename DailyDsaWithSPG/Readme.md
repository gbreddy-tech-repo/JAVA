...
My Goal: Solve at least one problem daily to keep away from interview fear, my unemployement and to become a good problem solver.

# JANUARY 2022


| Day | Date       | Topic(s) | Difficulty | Problem(s)  | Solution 1 | Solution 2 | Topics Learnt |
| --- |:----------:| -----:| ----------:| -----------:| ----------:| ----------:| ----------:|
| 1   | 01/01/2022 | Array | Easy ✅ | [TwoSum](https://leetcode.com/problems/two-sum/) | 
